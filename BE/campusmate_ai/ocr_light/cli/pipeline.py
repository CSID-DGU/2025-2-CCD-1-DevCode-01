...
def run_pipeline(input_path: str, out_path: str, model: str = "qwen2.5:1.5b-instruct"):
    from campusmate_ai.ocr_light.cli import pipeline
    import subprocess, tempfile, os
    import sys

    tmp_out = out_path or os.path.join(tempfile.mkdtemp(), "result.md")

    cmd = [
        sys.executable,
        "-m",
        "campusmate_ai.ocr_light.cli.pipeline",
        "--input", input_path,
        "--out", tmp_out,
        "--keep",
        "--workers", "1",
